...
BEGIN {
	...
	sections["silent"] = sections["silent"] ";";
	sections["silent"] = sections["silent"] "MPSS_RESTART_STACK:^yes$:^no$";
	sections["silent"] = sections["silent"] ";";
	sections["silent"] = sections["silent"] "MPSS_INSTALL_STACK:^yes$:^no$";
	sections["silent"] = sections["silent"] ";";
	sections["silent"] = sections["silent"] "MPSS_KNL_INSTALL_STACK:^yes$:^no$";
	sections["silent"] = sections["silent"] ";";
