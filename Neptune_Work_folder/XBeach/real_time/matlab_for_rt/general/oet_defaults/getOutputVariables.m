...
% $Date: 2010-04-27 09:04:13 +0200 (di, 27 apr 2010) $
% $Author: heijer $
% $Revision: 2493 $
% $HeadURL: https://repos.deltares.nl/repos/OpenEarthTools/trunk/matlab/general/oet_defaults/getOutputVariables.m $
% $Keywords:
