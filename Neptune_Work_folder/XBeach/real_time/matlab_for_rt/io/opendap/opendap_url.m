...
% $Id: opendap_url.m 3472 2010-12-01 13:18:00Z heijer $
% $Date: 2010-12-01 14:18:00 +0100 (wo, 01 dec 2010) $
% $Author: heijer $
% $Revision: 3472 $
% $HeadURL: https://repos.deltares.nl/repos/OpenEarthTools/trunk/matlab/io/opendap/opendap_url.m $
% $Keywords: $

%%
OPT = struct(...
    'localpath', 'p:\mcdata',...
    'opendapurl', 'http://opendap.deltares.nl:8080/',...
    'infix', 'opendap',...
    'protocol', 'THREDDS',...
    'verbose', true);
