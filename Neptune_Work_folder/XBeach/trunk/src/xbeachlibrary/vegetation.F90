...
module vegetation_module
    ...
    type veggie
        ...
        integer ,                   pointer :: npts        ! Number of points used in vertical schematization of vegetation [-]
        integer ,                   pointer :: nsec        ! (OLD) Number of points used in vertical schematization of vegetation [-]
